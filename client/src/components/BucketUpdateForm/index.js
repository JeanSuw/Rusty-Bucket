...
//       const unixTimestamp = Math.round(parsedDueDate.getTime() / 1000);
...
//           ...bucketData,
//           priority: parseInt(bucketData.priority),
//           dueDate: bucketData.dueDate.toString(), // Convert dueDate to a string
//         },
//       });
...
//         <div className="form-field">
//           <DatePicker
//             selected={bucketData.dueDate ? new Date(bucketData.dueDate * 1000) : null}
//             onChange={handleDateChange}
//             dateFormat="dd/MM/yyyy"
//             placeholderText="Due Date"
//             showYearDropdown
